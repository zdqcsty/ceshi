...
public class DBUtils {
    ...
    private static String URL = "jdbc:bonchive2://10.130.7.204:10001/devtest;principal=hs2/hadooptd3.novalocal@DEVTEST.BONC;auth=kerberos";
...
// 连接数据库
    ...
    public static void main(String[] args) throws SQLException {
        ...
        map.put("header", "true");
        ((org.apache.spark.sql.hive.jdbc.HiveConnection)connection).constructTable("devtest.vbapff908cd5daef23bbf38f6336_parquet",arrayList,"/user/zgh/eee","csv","overwrite",map);
